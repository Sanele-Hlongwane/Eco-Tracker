  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor: theme.backgroundColor }]}>
     ...
     <Text style={[styles.contentText, { color: theme.textColor }]}>
      ...
      <Text style={[styles.contentText, { color: theme.textColor }]}>
        7. <Text style={[styles.highlight, { color: theme.buttonColor }]}>Contact Us:</Text> If you have questions about our Privacy Policy, please contact us at <Text style={styles.highlightC}>ecotracker@gmail.com</Text>
      </Text>
    </ScrollView>
  );
};
