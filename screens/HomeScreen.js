...
const HomeScreen = ({ navigation }) => {
  ...
  const userPicture = userDetails.avatar || require('../images/Solar.jpg' );
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.backgroundColor }]}>
      ...
      <Text style={[styles.subtitle, { color: theme.textColor }]}>Your Friend in Keeping Mother Earth Healthy</Text>
      ...
      <View  style={[styles.contentContainer, { backgroundColor: theme.contentColor }]}>
        <Text style={[styles.contentTitle, { color: theme.titleColor }]}>Your Carbon Emmission Sumary</Text>
  ...
  <Text style={[styles.contentText, { color: theme.titleColor }]}>%</Text>
      ...
      <View style={[styles.contentContainer, { backgroundColor: theme.contentColorTwo }]}>
        ...
        <Text style={[styles.contentText, { color: theme.textColor }]}>
          - <Text style={[styles.highlight, { color: theme.backgroundColor }]}>Reduce:</Text> Consume less, use resources
          efficiently, and buy only what you need.
        </Text>
        <Text style={[styles.contentText, { color: theme.textColor }]}>
          - <Text style={[styles.highlight, { color: theme.backgroundColor }]}>Reuse:</Text> Find creative ways to use items
          again or repurpose them.
        </Text>
        <Text style={[styles.contentText, { color: theme.textColor }]}>
          - <Text style={[styles.highlight, { color: theme.backgroundColor }]}>Recycle:</Text> Properly recycle materials to
